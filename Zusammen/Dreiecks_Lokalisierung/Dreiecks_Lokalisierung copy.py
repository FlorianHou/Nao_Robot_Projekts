...
class DreiecksLokalisierung():
    ...
    def kamBreit(self,CamId = 0,Res = 3,ColorSpace = 13,fps = 30):
        ...
        # AutoExposition
        self.video_cam.setParameter(CamId,11,1)
        # self.video_cam.setParameter(CamId,17,700)
        # CameraSharpness
        self.video_cam.setParameter(CamId,24,2)
         # Kamera Oeffnet
    ...
    def get_kontours_3(self):
        ...
        img_gruen = cv.inRange(img_hsv, (50, 100, 50), (80,255,255))
        ...
        lines = cv.HoughLines(img_bg, 1, pi/180, 120)
        ...
        lines = cv.HoughLines(img_blau, 1, pi/180, 105)
