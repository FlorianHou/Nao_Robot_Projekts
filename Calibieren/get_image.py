...
# 0 ist obere Kamera
CamId = 0
# 3 ist k4VGA(1280*960),2 ist VGA(VGA funktionert nicht, andere sind Ok), 1 ist 320*240
Res = 1
#BGR-13
ColorSpace = 13
# FPS
...
# Subscribe Kamera
# Komischerweise kann ein gleicher Name des Subscriber(hier ist "Kamera_Get") nicht mehr als 6 mals angewendet werden, wenn Ein Fehler gibt,
...
while True:
    ...
    # druck "s" zu speichen, "n" zu naeschste Bild, q zu schliessen
    if k == ord("s"):
        count += 1
