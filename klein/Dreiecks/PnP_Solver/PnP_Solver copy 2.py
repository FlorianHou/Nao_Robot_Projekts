...
def Robot2Ziel_ROB(robot2CamROB):
    ...
    Tr_X = almath.Transform.fromPosition(-50., 0., 0.)
    robot2CamOP = robot2CamROB * RotZ_1 * RotX_1 * Tr_X
...
result = visionCompass.setResolution(2)
print result

# visionCompass.moveTo(robot2ZielROB_Pose2D[0]/100,robot2ZielROB_Pose2D[1]/100,robot2ZielROB_Pose2D[2])
motion.moveTo(robot2ZielROB_Pose2D[0]/100,robot2ZielROB_Pose2D[1]/100,robot2ZielROB_Pose2D[2])
