...
def PnP_Solve():
    ...
    ret, rvecs, tvecs = cv.solvePnP(objp, corners2, mtx, dist, flags=cv.SOLVEPNP_IPPE)
...
def Cam2Ziel_OP():
    ...
    b = np.array(PnP_Ergebnis_dict["tvecs"])/100 # Einheit von cm zu m
...
def Robot2Ziel_ROB(robot2CamROB):
    ...
    Tr_X = almath.Transform.fromPosition(0., 0.5, 0.)
